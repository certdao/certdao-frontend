...
export const GOERLI_ALCHEMY_API_KEY =
  process.env.REACT_APP_GOERLI_ALCHEMY_API_KEY;
export const MAINNET_ALCHEMY_API_KEY =
  process.env.REACT_APP_MAINNET_ALCHEMY_API_KEY;
